...
app.layout = html.Div(
    [
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        ...
                        dcc.Markdown(
                            id="pie_description", style={"margin-top": "20px"}
                        ),
                    ]
                ),
                # Sum chart
                html.Div(
                    [
                        ...
                        dcc.Markdown(
                            id="sum-description", style={"margin-top": "20px"}
                        ),
                    ]
                ),
                # Maps
                html.Div(
                    [
                        ...
                        dcc.Markdown(
                            id="map-description", style={"margin-top": "20px"}
                        ),
                    ],
            ...
            id="global-content",
            style={},  # Vous pouvez définir un style de base ici
        ),
    ]
)
...
@app.callback(Output("global-content", "style"), [Input("dark-mode-toggle", "on")])
def toggle_dark_mode(on):
    if on:
        dark_mode_style = {
